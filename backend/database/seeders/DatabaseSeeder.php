...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $products = [
            ['name' => 'Santal 33', 'house' => 'Le Labo', 'category' => 'Madera', 'scent_family' => 'Amaderada', 'occasion' => 'Diario', 'price' => 4250, 'rating' => 4.9, 'reviews_count' => 128, 'badge' => 'Más vendido', 'description' => 'Una composición que habla de madera, fuego y libertad. Un clásico moderno con carácter inconfundible.', 'notes' => ['Cardamomo', 'Iris', 'Madera de cedro'], 'stock' => 68, 'image' => 'https://images.unsplash.com/photo-1541643600914-78b084683601?auto=format&fit=crop&w=900&q=85'],
            ...
            ['name' => 'The Noir 29', 'house' => 'Le Labo', 'category' => 'Madera', 'scent_family' => 'Amaderada', 'occasion' => 'Noche', 'price' => 4350, 'rating' => 4.8, 'reviews_count' => 89, 'description' => 'Una interpretación profunda y elegante de la hoja de higuera y el té negro.', 'notes' => ['Higo', 'Té negro', 'Laurel'], 'image' => 'https://images.unsplash.com/photo-1588405748880-12d1d2a59f75?auto=format&fit=crop&w=900&q=85'],
            ['name' => 'Musc Ravageur', 'house' => 'Frederic Malle', 'category' => 'Especiada', 'scent_family' => 'Almizclada', 'occasion' => 'Fiesta', 'price' => 5180, 'rating' => 4.5, 'reviews_count' => 47, 'description' => 'Un perfume cálido y sensual de especias, vainilla y almizcle.', 'notes' => ['Canela', 'Vainilla', 'Almizcle'], 'image' => 'https://images.unsplash.com/photo-1563170351-be82bc888aa4?auto=format&fit=crop&w=900&q=85'],
        ...
        foreach ($products as $product) {
            $savedProduct = Product::query()->updateOrCreate(['name' => $product['name'], 'house' => $product['house']], $product);
            foreach ([['label' => '30 ml', 'volume_ml' => 30, 'price' => max(0, $savedProduct->price - 1470)], ['label' => '50 ml', 'volume_ml' => 50, 'price' => $savedProduct->price], ['label' => '100 ml', 'volume_ml' => 100, 'price' => $savedProduct->price + 1450]] as $variant) {
                ProductVariant::query()->updateOrCreate(['product_id' => $savedProduct->id, 'volume_ml' => $variant['volume_ml']], [...$variant, 'stock' => $savedProduct->stock]);
            }
        }
    }
}
