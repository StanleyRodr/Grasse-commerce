...
const placeOrder = () => { if (canSubmit.value) submitted.value = true }
</script>
...
<template>
  <div class="checkout-page">
    ...
    <main v-else class="order-success"><div class="success-icon"><Check :size="30" /></div><p class="eyebrow">Pedido recibido</p><h1>Gracias por elegir <em>Grasse</em>.</h1><p>Tu pedido de prueba fue registrado correctamente. Enviaremos confirmación a <strong>{{ email }}</strong>.</p><span class="order-number">ORDEN #GR-2026-0018</span><RouterLink to="/" class="primary-button">Volver al inicio <ArrowLeft :size="16" /></RouterLink></main>
  </div>
</template>
